      ...
      setDaData({
        ...
        data: {
          'priroty': [['low', 21, 4.2], 
            ...
            ['medium', 127, 1.2]],
          'violations': [
            ['ARIA role must be appropiate for the element', 4, 0.6],
            ['ARIA role must be appropiate for the element', 3, 0.6],
            ['ARIA role must be appropiate for the element', 3, 0.6],
            ['ARIA role must be appropiate for the element', 4, 0.6],
            ['ARIA role must be appropiate for the element', 4, 0.6],
          ]
    ...
    <Grid container xs={12} md={11} lg={11}>
      {Object.keys(daData.data).map((title) => (
        <Grid style={{ padding:20}} item xs={12} md={12} lg={12}>
          {/* <h2>{title}</h2>
                <br /> */}
          <TableContainer style={{  maxHeight: 280 }} component={Paper}>
            <Table stickyHeader >
              <TableHead>
        ...
        <div className="container relative p-16 sm:p-24 flex flex-row justify-between items-center">
          ...
          <FuseAnimate delay={100}>
            <div className="flex-col">
              <Typography className="h2" color="textPrimary">Voilations over time</Typography>
