...
function Widget4(props)
{
    ...
    return (
        <Card className="w-full rounded-8 shadow-none border-1 ">
            ...
            <div className="p-16 pb-0 flex flex-row items-end flex-wrap wigAdding-icons">

                <div className="pr-16">
                    <Typography className="h3" color="textSecondary">{props.data.numbersOfHeaders}</Typography>
                    <Typography className="text-56 font-300 leading-none mt-8">
                        {props.data.visits.value}
                    </Typography>
                </div>
                <img  class="material-icons wigAdding-icons-i" src="assets/images/cards/audio.png" alt="audio"/>
