...
function Widget2(props)
{
    ...
    return (
        <Card className="w-full rounded-8 shadow-none border-1">
            ...
            <div className="p-16 pb-0 flex flex-row flex-wrap items-end wigAdding-icons">
                ...
                <img class="material-icons wigAdding-icons-i" src="assets/images/cards/video.png" alt="video"/>
